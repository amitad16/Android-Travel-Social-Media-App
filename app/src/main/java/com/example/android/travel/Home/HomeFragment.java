...
public class HomeFragment extends Fragment {
    ...
    private ArrayList<Photo> mPaginationPhotos;
    ...
    private void displayPhotos(){
        mPaginationPhotos = new ArrayList<>();
        if(mPhotos != null){
            try {
                 ...
                 for (int i = 0; i < iterations; i++) {
                     mPaginationPhotos.add(mPhotos.get(i));
                 }

                mAdapter = new MainfeedListAdapter(getActivity(), R.layout.layout_mainfeed_listitem, mPaginationPhotos);
